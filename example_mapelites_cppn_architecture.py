...
plot = plotgrid.plot(phenotypes, domain, features=features, fitness=fitness, niches=niches, rawfeatures=rawfeatures, filename=output_visualization_file, gridresolution=config['resolution'], output_resolution=[4000, 4000])
